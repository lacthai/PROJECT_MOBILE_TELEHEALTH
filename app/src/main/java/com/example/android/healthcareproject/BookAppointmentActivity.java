...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed4 = findViewById(R.id.editTextAppFees); //set the text display on the layout
        ...
        ed4.setKeyListener(null); //remove the click on the edit texts - all the edit text are not clickable
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(BookAppointmentActivity.this, FindHospitalActivity.class));
            }
        });
